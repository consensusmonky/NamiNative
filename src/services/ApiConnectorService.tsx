...
import { ADA_HANDLE, APIError, ERROR, NETWORK_ID, STORAGE, TxSendError } from "../constants/Common";
import { AccountInfo, Asset, NetworkDefaultStats, Unit } from "../types/Network";
import { Network } from "../types/Network";
import { getInitalNetwork } from "../utils/NetworkData";
import { Buffer } from "buffer";
import { Wallet } from "../storage/Wallet";
import { delay } from "../utils/Common";
import provider from "../constants/ApiProvider";
import { hexToAscii, utxoFromJson } from "../utils/LedgerData";
...
export const setTxDetail = (txHash: string, txDetail: any) => {
  const accounts = Wallet.getArray<AccountInfo>(STORAGE.accounts);
...
export const updateBalance = async (currentAccount: AccountInfo) => {
  ...
  Wallet.setArray(STORAGE.accounts, [currentAccount]);
...
// NamiNative always uses only one account yet
